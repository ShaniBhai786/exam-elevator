...
import { MathematicsCourse } from './outline'

const page = () => {
  const [isSelected, setIsSelected] = useState(false)
    let subject = "math deficiency";
    return (
        <>
            <div className={styles.container}>
                <h1>Math Deficiency</h1>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={MathematicsCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
