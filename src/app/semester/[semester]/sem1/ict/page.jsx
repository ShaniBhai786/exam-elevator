...
import { ComputerFundamentalsCourse } from './outline'
    ...
    return (
        <>
            <div className={styles.container}>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={ComputerFundamentalsCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
