...
import { EnglishWritingSkillsCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "english literature and writing skills";
    return (
        <>
        <div className={styles.container}>
            <h1>English Literature and Writing Skills</h1>
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                <AiGenerator CourseOutline={EnglishWritingSkillsCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
        <SideBar />
        </>
    )
