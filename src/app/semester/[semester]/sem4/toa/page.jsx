...
import { AutomataTheoryCourse } from "./outline"

const page = () => {
        const [isSelected, setIsSelected] = useState(false)
    let subject = "Theory of Automata";
    return (
        <>
        <div className={styles.container}>
            ...
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                <AiGenerator subject={subject} CourseOutline={AutomataTheoryCourse} setIsSelected={setIsSelected} /> :
                <div className={styles.container}>
