...
import { MultivariableCalculusCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
  let subject = "Multivariable Calculus"
  return (
    <>
            ...
            </div>
      {
        isSelected === 1 ?
          ...
          isSelected === 2 ?
            ...
            isSelected === 3 ?
              <AiGenerator subject={subject} CourseOutline={MultivariableCalculusCourse} setIsSelected={setIsSelected} /> : null
      }
      <SideBar />
    </>
  )
