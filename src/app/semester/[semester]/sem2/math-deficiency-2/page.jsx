...
import { CalculusAndDiscreteMathematicsCourse } from './outline'

const page = () => {
  const [isSelected, setIsSelected] = useState(false)
    let subject = "calculus and discrete mathematics";
    return (
        <>
            <div className={styles.container}>
                <h1>Calculus and Discrete Mathematics II</h1>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={CalculusAndDiscreteMathematicsCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
