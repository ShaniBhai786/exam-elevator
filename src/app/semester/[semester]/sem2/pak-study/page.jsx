...
import { PakistanStudiesCourse } from './outline'

const page = () => {
  const [isSelected, setIsSelected] = useState(false)
    let subject = "pakistan studies";
    return (
        <>
            <div className={styles.container}>
                <h1>Pakistan Studies</h1>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={PakistanStudiesCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
