...
import { BusinessCommunicationCourse } from "./outline"

const page = () => {
        const [isSelected, setIsSelected] = useState(false)
    let subject = "communication and presentation skills";
    return (
        <>
        <div className={styles.container}>
            <h1>Communication and Presentation Skills</h1>
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                            <AiGenerator subject={subject} CourseOutline={BusinessCommunicationCourse} setIsSelected={setIsSelected} /> :
                <div className={styles.container}>
