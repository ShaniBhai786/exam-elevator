...
import { SocialWorkCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "social services";
    return (
        <>
        <div className={styles.container}>
            ...
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                <AiGenerator CourseOutline={SocialWorkCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
        <SideBar />
        </>
    )
