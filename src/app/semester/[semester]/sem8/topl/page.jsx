...
import { ProgrammingLanguageTheoryCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "theory of programming language";
    return (
        <>
        <div className={styles.container}>
            ...
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                <AiGenerator CourseOutline={ProgrammingLanguageTheoryCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
        <SideBar />
        </>
    )
