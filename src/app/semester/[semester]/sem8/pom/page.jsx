...
import { ManagementCourse } from './outline'

const page = () => {
  const [isSelected, setIsSelected] = useState(false)
    let subject = "principles of management";
    return (
        <>
            <div className={styles.container}>
                <h1>Principles of Management</h1>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={ManagementCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
