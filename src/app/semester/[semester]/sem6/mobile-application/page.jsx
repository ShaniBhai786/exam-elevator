...
import { MobileApplicationDevelopment } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "mobile application development";
    return (
        <>
        <div className={styles.container}>
            ...
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                <AiGenerator CourseOutline={MobileApplicationDevelopment} subject={subject} setIsSelected={setIsSelected} /> : null
                }
        <SideBar />
        </>
    )
