...
import { AdvancedNetworkingLabCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "computer networks lab";
  return (
    <>
            ...
            </div>
      {
        isSelected === 1 ?
          ...
          isSelected === 2 ?
            ...
            isSelected === 3 ?
              <AiGenerator subject={subject} CourseOutline={AdvancedNetworkingLabCourse} setIsSelected={setIsSelected} /> : null
      }
      <SideBar />
    </>
  )
