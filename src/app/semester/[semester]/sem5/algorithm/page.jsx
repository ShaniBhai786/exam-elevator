...
import { AdvancedAlgorithmsCourse } from "./outline"

const page = () => {
        const [isSelected, setIsSelected] = useState(false)
    let subject = "algorithms and design analysis";
    return (
        <>
        <div className={styles.container}>
            <h1>Algorithm and Design Analysis</h1>
            <div className={styles.selection}>
                ...
                isSelected === 3 ?
                            <AiGenerator subject={subject} CourseOutline={AdvancedAlgorithmsCourse} setIsSelected={setIsSelected} /> :
                <div className={styles.container}>
