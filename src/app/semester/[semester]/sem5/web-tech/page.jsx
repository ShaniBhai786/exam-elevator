...
import { WebApplicationDevelopmentCourse } from './outline'
    ...
    return (
        <>
            <div className={styles.container}>
                ...
                isSelected === 3 ? 
                <AiGenerator CourseOutline={WebApplicationDevelopmentCourse} subject={subject} setIsSelected={setIsSelected} /> : null
                }
            <SideBar />
        </>
    )
