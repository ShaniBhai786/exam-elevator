...
import { LinuxOperatingSystemCourse } from './outline'

const page = () => {
    const [isSelected, setIsSelected] = useState(false)
    let subject = "operating system lab"
  return (
    <>
            ...
            </div>
      {
        isSelected === 1 ?
          ...
          isSelected === 2 ?
            ...
            isSelected === 3 ?
              <AiGenerator subject={subject} CourseOutline={LinuxOperatingSystemCourse} setIsSelected={setIsSelected} /> : null
      }
      <SideBar />
    </>
  )
